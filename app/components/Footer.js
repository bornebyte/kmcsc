        ...
        <footer className="text-gray-400 bg-gray-900 body-font">
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    ...
                    <p className="mt-2 text-sm text-gray-500">As student leaders, our unity creates infinite possibilities.</p>
                </div>
            ...
            <div className="bg-gray-800 bg-opacity-75">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-400 text-sm text-center sm:text-left">© 2023 KMCSC —
                        <a href="https://www.facebook.com/shubham.shah.1888" rel="noopener noreferrer" className="text-gray-500 ml-1" target="_blank">@shubham shah</a>
                    </p>
